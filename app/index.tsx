  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View style={styles.container}>
        ...
        <Box color="#FF4444" title="Urgent and Important" />

        {/* Coral Box - Important */}
        <Box color="#FF7F50" title="Important" />

        {/* Orange Box - Urgent */}
        <Box color="#FFA500" title="Urgent" />

        {/* Amber Box - To Do */}
        <Box color="#FFBF00" title="To Do" />
      </View>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    backgroundColor: "#25292e", // Dark gray background color
